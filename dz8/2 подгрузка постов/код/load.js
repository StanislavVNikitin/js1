...
function insertPosts() {
    ...
    let scrollCheckElement = document.getElementsByClassName('scrollCheck')[0];
    let divPostMarkup = document.createElement('div');
    divPostMarkup.innerHTML = postsMarkup;
    scrollCheckElement.appendChild(divPostMarkup);
